sudo apt install -y cmake build-essential pkg-config libfontconfig1-dev libxcb-xfixes0-dev libxkbcommon-dev python3 \
                    ffmpeg 7zip jq poppler-utils fd-find ripgrep fzf zoxide tmux xclip dotnet-sdk-9.0
