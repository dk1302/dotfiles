...
hl.curve( "main", { type = "spring", mass = 1, stiffness = 70, dampening = 7 } )
hl.curve( "float", { type = "spring", mass = 0.6, stiffness = 70, dampening = 7 } )

hl.animation({ leaf = "windows", enabled = true, speed = 4.79, bezier = "easeOutQuint" })
hl.animation({ leaf = "fadeIn", enabled = true, speed = 1.73, bezier = "easeInQuint" })
...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 1.5, spring = "float", style = "slide top" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1.49, bezier = "linear", style = "popin 87%" })
hl.animation({ leaf = "workspaces", enabled = true, speed = 3, bezier = "easeInOutCustom", style = "slide" })
hl.animation({ leaf = "specialWorkspaceIn", enabled = true, speed = 2.21, spring = "float", style = "slide bottom" })
